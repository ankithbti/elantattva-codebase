	...
	<div class="row styledText">
	  	<div class="span3 bs-docs-sidebar">
		    <ul class="nav nav-list bs-docs-sidenav">
		      <li><a href="#suresh"><i class="icon-chevron-right"></i> <i class="icon-user"></i> Suresh Sivaraman</a></li>
	  	...
	  	<div class="span9">
	        ...
	        <section id="suresh">
	          <div class="page-header">
	            <h1><img src="img/suresh.png" class="img-rounded img-polaroid" style="width:50px;height:50px;"/> Suresh Sivaraman</h1>
	          </div>
	          
		          
	          <p><strong>Suresh Sivaraman</strong> (Co-Founder of Elan Tattva, Certified NLP trainer [ANLP India], Certified Advanced Life Coach [ANLP India], Reiki Master).</p>
	        ...
	        <section id="kiran">
	          <div class="page-header">
	            <h1><img src="img/kiran.png" class="img-rounded img-polaroid" style="width:50px;height:50px;"/> Kiran Shetty</h1>
	          </div>
	          ...
	          Yoga Instructors Course from SVYASA Yoga University, Bangalore
				Teachers Training Course, Bihar Yoga School, Bihar (World’s first Yoga University)
				Post Graduate Diploma in Yoga Therapy, SVYASA Yoga University, Bangalore (Pursuing)
				Black Belt 3rd Dan in Karate and medal winner at National Karate tournament
				Certification course in Psychology from Indian Psychology Institute, Pondicherry.
				</p>
	        </section>
	        ...
	        <section id="kabir">
	          <div class="page-header">
	            <h1><img src="img/kabir.png" class="img-rounded img-polaroid" style="width:50px;height:50px;"/> Kabir Ahluwalia</h1>
	          </div>
