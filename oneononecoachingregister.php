<?php
    ...
    if( isset($_POST['rsubmitted'] ) ) {
        ...
        if( $_SESSION['security_code'] == $_POST['security_code'] && !empty($_SESSION['security_code'])) {
            ...
            header("Location:" . $back_page . "?rerror=Captcha Image text entered was not correct. Try again.&email=" . $email . 
                                                                                                        "&name=" . $name . 
                                                                                                        "&phone=" . $phone . 
                                                                                                        "&org=" . $org . 
                                                                                                        "&role=" . $role . 
        ...
        header("Location:" . $back_page . "?rerror=Something fisshy!!!!!. You need to submit form first.");
        mysql_close(); // Close the database connection
        die('should have redirected by now');
    }
?>