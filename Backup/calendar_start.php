...
<div id='calendar_wrap'>
	<div class='title_bar'>
		<div class='previous_month'><input class="btn btn-primary" name="myBtn" type="submit" value="Previous Month" onClick="javascript:last_month();" /></div>
		<div class='show_month'><?php echo $month_name . ' ' . $showyear ; ?></div>
		<div class='next_month'><input class="btn btn-primary" name="myBtn" type="submit" value="Next Month" onClick="javascript:next_month();" /></div>
	</div><br/><br/>
	<div class='week_days'>
	...
	<?php
		...
		for($i = 1 ; $i <= $day_count ; $i++){
			...
			if($num_rows > 0){
				$event = "<input type='submit' name='$date' value='Event is there :)' id='$date' onClick='javascript:show_events(this);'>"; 
