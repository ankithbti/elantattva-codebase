...
<header class="jumbotron subhead" id="overview">
  <div class="container">    
    ...
    <p class="lead">In this page you can manage and monitor your Thought Of Day (TOD) !!!!</p>
...
<div class="container">
  <p align="center">
    <input onclick="createEditor();" type="button" class='btn btn-success' value="Add New Thought of Day">
    <input onclick="hideEditor();" type="button" class='btn btn-success' value="Hide Editor">
  </p>
  <!-- This div will hold the editor. -->
  <div id='submitForm'>
      <textarea cols="80" id="thought" name="thought" placeholder="Enter Thought" rows="10"></textarea>
      <br/>
